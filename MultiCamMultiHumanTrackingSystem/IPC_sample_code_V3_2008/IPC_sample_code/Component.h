...
public:
	...
	//set block locatons
	bool LocateBlocks(const CameraLine3D * headline, CameraLine3D & groundline, bool h_is_got, double h = -10.0);
...
public:
	...
	ObjectInfo(){indexInfo[CAM1]=indexInfo[CAM2]=NONDEFINED; conf = OBJ_NON_DEFINED;}
	...
	ObjectInfo(BodyInfo* biptr, int obsIndex_cam1, int obsIndex_cam2, OBJ_CONFIDENCE obj_conf/* = OBJ_NON_DEFINED*/){objectBodyInfo = *biptr; indexInfo[CAM1] = obsIndex_cam1; indexInfo[CAM2] = obsIndex_cam2; conf = obj_conf;}
