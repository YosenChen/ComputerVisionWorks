...
bool trans2CamLine(CamLineMgr_CAM1_OB1* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
		{
			if (!(int(j - BLOCK_WIDTH*0.5 + src->imageLoc[0]) >= 0 && int(j - BLOCK_WIDTH*0.5 + src->imageLoc[0]) < IMG_WIDTH)) continue;
			CV_IMAGE_ELEM(outImgCr, unsigned char, i, int(j - BLOCK_WIDTH*0.5 + src->imageLoc[0])) = src->imgdataCr[(int)BLOCK_WIDTH*i + j];
			CV_IMAGE_ELEM(outImgCb, unsigned char, i, int(j - BLOCK_WIDTH*0.5 + src->imageLoc[0])) = src->imgdataCb[(int)BLOCK_WIDTH*i + j];
		}
	}
	dst->camID = CAM1;
...
bool trans2CamLine(CamLineMgr_CAM1_OB2* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM1_OB3* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM1_OB4* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM1_OB5* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM2_OB1* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM2_OB2* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM2_OB3* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM2_OB4* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM2_OB5* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM3_OB1* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM3_OB2* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM3_OB3* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM3_OB4* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM3_OB5* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLineMgr(IplImage* inImgCr, IplImage* inImgCb, CameraLine3D* src, CamLineMgr_CAM1_OB1* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
		{
			if (!(int(j - BLOCK_WIDTH*0.5 + src->imageLoc.x) >= 0 && int(j - BLOCK_WIDTH*0.5 + src->imageLoc.x) < IMG_WIDTH)) continue;
			dst->imgdataCr[(int)BLOCK_WIDTH*i + j] = CV_IMAGE_ELEM(inImgCr, unsigned char, i, int(j - BLOCK_WIDTH*0.5 + src->imageLoc.x));
			dst->imgdataCb[(int)BLOCK_WIDTH*i + j] = CV_IMAGE_ELEM(inImgCb, unsigned char, i, int(j - BLOCK_WIDTH*0.5 + src->imageLoc.x));
		}
	}
...
bool trans2CamLineMgr(IplImage* inImgCr, IplImage* inImgCb, CameraLine3D* src, CamLineMgr_CAM1_OB2* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLineMgr(IplImage* inImgCr, IplImage* inImgCb, CameraLine3D* src, CamLineMgr_CAM1_OB3* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLineMgr(IplImage* inImgCr, IplImage* inImgCb, CameraLine3D* src, CamLineMgr_CAM1_OB4* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLineMgr(IplImage* inImgCr, IplImage* inImgCb, CameraLine3D* src, CamLineMgr_CAM1_OB5* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLineMgr(IplImage* inImgCr, IplImage* inImgCb, CameraLine3D* src, CamLineMgr_CAM2_OB1* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLineMgr(IplImage* inImgCr, IplImage* inImgCb, CameraLine3D* src, CamLineMgr_CAM2_OB2* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLineMgr(IplImage* inImgCr, IplImage* inImgCb, CameraLine3D* src, CamLineMgr_CAM2_OB3* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLineMgr(IplImage* inImgCr, IplImage* inImgCb, CameraLine3D* src, CamLineMgr_CAM2_OB4* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLineMgr(IplImage* inImgCr, IplImage* inImgCb, CameraLine3D* src, CamLineMgr_CAM2_OB5* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLineMgr(IplImage* inImgCr, IplImage* inImgCb, CameraLine3D* src, CamLineMgr_CAM3_OB1* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLineMgr(IplImage* inImgCr, IplImage* inImgCb, CameraLine3D* src, CamLineMgr_CAM3_OB2* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLineMgr(IplImage* inImgCr, IplImage* inImgCb, CameraLine3D* src, CamLineMgr_CAM3_OB3* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLineMgr(IplImage* inImgCr, IplImage* inImgCb, CameraLine3D* src, CamLineMgr_CAM3_OB4* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
...
bool trans2CamLineMgr(IplImage* inImgCr, IplImage* inImgCb, CameraLine3D* src, CamLineMgr_CAM3_OB5* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<BLOCK_WIDTH; j++)
