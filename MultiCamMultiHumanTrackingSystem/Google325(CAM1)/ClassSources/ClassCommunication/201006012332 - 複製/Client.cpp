...
//--------------------------------------------------//
typedef pair<string, void (*)(MSG_INSTANCE, BYTE_ARRAY, void *)> message_pair;
static map<string, message_pair > message_handlers;
...
void IPCClientMgr::subscribe(const char* first, ...)
{
	...
	while( msgName != NULL ){
		printf( "subscribe %s\n", msgName );
		string str_msg(msgName);
		message_pair mp = message_handlers[str_msg];
		IPC_CS.lock();
		define_message( msgName, mp.first.c_str() );
...
void IPCClientMgr::publish(const char* first, ...)
{
	...
	while( msgName != NULL ){
		...
		IPC_CS.lock();
		string str_msg(msgName);
		define_message( msgName, message_handlers[str_msg].first.c_str() );
		IPC_CS.unlock();
		msgName = va_arg( arg_list, const char* );
	}
...
{
	//////////message_handlers[string(LASERPOSE_NAME)] = message_pair( string(LASERPOSE_FORMAT), &laserpose_message_handler );
	//////////message_handlers[string(SLASER_NAME)] = message_pair( string(SLASER_FORMAT), &slaser_message_handler );
	//////////message_handlers[string(SUBGOAL_NAME)] = message_pair(string( SUBGOAL_FORMAT), &subgoal_message_handler );
	//////////message_handlers[string(ODOMETRY_NAME)] = message_pair( string(ODOMETRY_FORMAT), &odometry_message_handler );
	//////////message_handlers[string(MOTOR_NAME)] = message_pair( string(MOTOR_FORMAT), &motor_message_handler );
	//////////message_handlers[string(SPEEDMODE_NAME)] = message_pair( string(SPEEDMODE_FORMAT), &SpeedMode_message_handler );
	//////////message_handlers[string(HEADMOTOR_NAME)] = message_pair( string(HEADMOTOR_FORMAT), &HeadMotor_message_handler );
	//////////message_handlers[string(HANDPOS_NAME)] = message_pair( string(HANDPOS_FORMAT), &handpos_message_handler );
	//////////message_handlers[string(FACIAlEXP_NAME)] = message_pair( string(FACIAlEXP_FORMAT), &facialexp_message_handler );
	//////////message_handlers[string(MIC19_NAME)] = message_pair( string(MIC19_FORMAT), &mic19_message_handler );
	//////////message_handlers[string(MIC20_NAME)] = message_pair(string( MIC20_FORMAT), &mic20_message_handler );
	//////////message_handlers[string(MIC21_NAME)] = message_pair( string(MIC21_FORMAT), &mic21_message_handler );
	//////////message_handlers[string(MIC22_NAME)] = message_pair( string(MIC22_FORMAT), &mic22_message_handler );
	//////////message_handlers[string(STATE_NAME)] = message_pair(string( STATE_FORMAT), &state_message_handler );
	//////////message_handlers[string(GOAL_NAME)] = message_pair(string( GOAL_FORMAT), &goal_message_handler );
	//////////message_handlers[string(PEOPLE_NAME)] = message_pair( string(PEOPLE_FORMAT), &people_message_handler );
	//////////message_handlers[string(WORD_NAME)] = message_pair( string(WORD_FORMAT), &word_message_handler );
	//////////message_handlers[string(DETECT_NAME)] = message_pair( string(DETECT_FORMAT), &detect_message_handler );
	//////////message_handlers[string(LOCSTATE_NAME)] = message_pair( string(LOCSTATE_FORMAT), &loc_state_message_handler );
	//////////message_handlers[string(SPEAK_NAME)] = message_pair( string(SPEAK_FORMAT), &speak_message_handler );

	//////////
	//////////message_handlers[string(HISTCRCB_CAM1_OB1_NAME)] = message_pair( string(HISTCRCB_CAM1_OB1_FORMAT), &histCrCb_CAM1_OB1_message_handler );
	//////////message_handlers[string(HISTCRCB_CAM1_OB2_NAME)] = message_pair( string(HISTCRCB_CAM1_OB2_FORMAT), &histCrCb_CAM1_OB2_message_handler );
	//////////message_handlers[string(HISTCRCB_CAM1_OB3_NAME)] = message_pair( string(HISTCRCB_CAM1_OB3_FORMAT), &histCrCb_CAM1_OB3_message_handler );
	//////////message_handlers[string(HISTCRCB_CAM1_OB4_NAME)] = message_pair( string(HISTCRCB_CAM1_OB4_FORMAT), &histCrCb_CAM1_OB4_message_handler );
	//////////message_handlers[string(HISTCRCB_CAM1_OB5_NAME)] = message_pair( string(HISTCRCB_CAM1_OB5_FORMAT), &histCrCb_CAM1_OB5_message_handler );
	//////////message_handlers[string(HISTCRCB_CAM2_OB1_NAME)] = message_pair( string(HISTCRCB_CAM2_OB1_FORMAT), &histCrCb_CAM2_OB1_message_handler );
	//////////message_handlers[string(HISTCRCB_CAM2_OB2_NAME)] = message_pair( string(HISTCRCB_CAM2_OB2_FORMAT), &histCrCb_CAM2_OB2_message_handler );
	//////////message_handlers[string(HISTCRCB_CAM2_OB3_NAME)] = message_pair( string(HISTCRCB_CAM2_OB3_FORMAT), &histCrCb_CAM2_OB3_message_handler );
	//////////message_handlers[string(HISTCRCB_CAM2_OB4_NAME)] = message_pair( string(HISTCRCB_CAM2_OB4_FORMAT), &histCrCb_CAM2_OB4_message_handler );
	//////////message_handlers[string(HISTCRCB_CAM2_OB5_NAME)] = message_pair( string(HISTCRCB_CAM2_OB5_FORMAT), &histCrCb_CAM2_OB5_message_handler );
	//////////message_handlers[string(HISTCRCB_CAM3_OB1_NAME)] = message_pair( string(HISTCRCB_CAM3_OB1_FORMAT), &histCrCb_CAM3_OB1_message_handler );
	//////////message_handlers[string(HISTCRCB_CAM3_OB2_NAME)] = message_pair( string(HISTCRCB_CAM3_OB2_FORMAT), &histCrCb_CAM3_OB2_message_handler );
	//////////message_handlers[string(HISTCRCB_CAM3_OB3_NAME)] = message_pair( string(HISTCRCB_CAM3_OB3_FORMAT), &histCrCb_CAM3_OB3_message_handler );
	//////////message_handlers[string(HISTCRCB_CAM3_OB4_NAME)] = message_pair( string(HISTCRCB_CAM3_OB4_FORMAT), &histCrCb_CAM3_OB4_message_handler );
	//////////message_handlers[string(HISTCRCB_CAM3_OB5_NAME)] = message_pair( string(HISTCRCB_CAM3_OB5_FORMAT), &histCrCb_CAM3_OB5_message_handler );

	//////////message_handlers[string(TEST_NAME)] = message_pair( string(TEST_FORMAT), &test_message_handler );
	//////////message_handlers[string(BODYINFO_CAM1_OB1_NAME)] = message_pair( string(BODYINFO_CAM1_OB1_FORMAT), &bodyInfo_CAM1_OB1_message_handler );
	//////////message_handlers[string(BODYINFO_CAM1_OB2_NAME)] = message_pair( string(BODYINFO_CAM1_OB2_FORMAT), &bodyInfo_CAM1_OB2_message_handler );
	//////////message_handlers[string(BODYINFO_CAM1_OB3_NAME)] = message_pair( string(BODYINFO_CAM1_OB3_FORMAT), &bodyInfo_CAM1_OB3_message_handler );
	//////////message_handlers[string(BODYINFO_CAM1_OB4_NAME)] = message_pair( string(BODYINFO_CAM1_OB4_FORMAT), &bodyInfo_CAM1_OB4_message_handler );
	//////////message_handlers[string(BODYINFO_CAM1_OB5_NAME)] = message_pair( string(BODYINFO_CAM1_OB5_FORMAT), &bodyInfo_CAM1_OB5_message_handler );
	//////////message_handlers[string(BODYINFO_CAM2_OB1_NAME)] = message_pair( string(BODYINFO_CAM2_OB1_FORMAT), &bodyInfo_CAM2_OB1_message_handler );
	//////////message_handlers[string(BODYINFO_CAM2_OB2_NAME)] = message_pair( string(BODYINFO_CAM2_OB2_FORMAT), &bodyInfo_CAM2_OB2_message_handler );
	//////////message_handlers[string(BODYINFO_CAM2_OB3_NAME)] = message_pair( string(BODYINFO_CAM2_OB3_FORMAT), &bodyInfo_CAM2_OB3_message_handler );
	//////////message_handlers[string(BODYINFO_CAM2_OB4_NAME)] = message_pair( string(BODYINFO_CAM2_OB4_FORMAT), &bodyInfo_CAM2_OB4_message_handler );
	//////////message_handlers[string(BODYINFO_CAM2_OB5_NAME)] = message_pair( string(BODYINFO_CAM2_OB5_FORMAT), &bodyInfo_CAM2_OB5_message_handler );
	//////////message_handlers[string(BODYINFO_CAM3_OB1_NAME)] = message_pair( string(BODYINFO_CAM3_OB1_FORMAT), &bodyInfo_CAM3_OB1_message_handler );
	//////////message_handlers[string(BODYINFO_CAM3_OB2_NAME)] = message_pair( string(BODYINFO_CAM3_OB2_FORMAT), &bodyInfo_CAM3_OB2_message_handler );
	//////////message_handlers[string(BODYINFO_CAM3_OB3_NAME)] = message_pair( string(BODYINFO_CAM3_OB3_FORMAT), &bodyInfo_CAM3_OB3_message_handler );
	//////////message_handlers[string(BODYINFO_CAM3_OB4_NAME)] = message_pair( string(BODYINFO_CAM3_OB4_FORMAT), &bodyInfo_CAM3_OB4_message_handler );
	//////////message_handlers[string(BODYINFO_CAM3_OB5_NAME)] = message_pair( string(BODYINFO_CAM3_OB5_FORMAT), &bodyInfo_CAM3_OB5_message_handler );


	//////////message_handlers[string(POS3D_CAM1_OB1_NAME)] = message_pair( string(POS3D_CAM1_OB1_FORMAT), &pos3D_CAM1_OB1_message_handler );
	//////////message_handlers[string(POS3D_CAM1_OB2_NAME)] = message_pair( string(POS3D_CAM1_OB2_FORMAT), &pos3D_CAM1_OB2_message_handler );
	//////////message_handlers[string(POS3D_CAM1_OB3_NAME)] = message_pair( string(POS3D_CAM1_OB3_FORMAT), &pos3D_CAM1_OB3_message_handler );
	//////////message_handlers[string(POS3D_CAM1_OB4_NAME)] = message_pair( string(POS3D_CAM1_OB4_FORMAT), &pos3D_CAM1_OB4_message_handler );
	//////////message_handlers[string(POS3D_CAM1_OB5_NAME)] = message_pair( string(POS3D_CAM1_OB5_FORMAT), &pos3D_CAM1_OB5_message_handler );
	//////////message_handlers[string(POS3D_CAM2_OB1_NAME)] = message_pair( string(POS3D_CAM2_OB1_FORMAT), &pos3D_CAM2_OB1_message_handler );
	//////////message_handlers[string(POS3D_CAM2_OB2_NAME)] = message_pair( string(POS3D_CAM2_OB2_FORMAT), &pos3D_CAM2_OB2_message_handler );
	//////////message_handlers[string(POS3D_CAM2_OB3_NAME)] = message_pair( string(POS3D_CAM2_OB3_FORMAT), &pos3D_CAM2_OB3_message_handler );
	//////////message_handlers[string(POS3D_CAM2_OB4_NAME)] = message_pair( string(POS3D_CAM2_OB4_FORMAT), &pos3D_CAM2_OB4_message_handler );
	//////////message_handlers[string(POS3D_CAM2_OB5_NAME)] = message_pair( string(POS3D_CAM2_OB5_FORMAT), &pos3D_CAM2_OB5_message_handler );
	//////////message_handlers[string(POS3D_CAM3_OB1_NAME)] = message_pair( string(POS3D_CAM3_OB1_FORMAT), &pos3D_CAM3_OB1_message_handler );
	//////////message_handlers[string(POS3D_CAM3_OB2_NAME)] = message_pair( string(POS3D_CAM3_OB2_FORMAT), &pos3D_CAM3_OB2_message_handler );
	//////////message_handlers[string(POS3D_CAM3_OB3_NAME)] = message_pair( string(POS3D_CAM3_OB3_FORMAT), &pos3D_CAM3_OB3_message_handler );
	//////////message_handlers[string(POS3D_CAM3_OB4_NAME)] = message_pair( string(POS3D_CAM3_OB4_FORMAT), &pos3D_CAM3_OB4_message_handler );
	//////////message_handlers[string(POS3D_CAM3_OB5_NAME)] = message_pair( string(POS3D_CAM3_OB5_FORMAT), &pos3D_CAM3_OB5_message_handler );



	message_handlers[string(CAMLINE_CAM1_OB1_NAME)] = message_pair( string(CAMLINE_CAM1_OB1_FORMAT), &camLine_CAM1_OB1_message_handler );
	message_handlers[string(CAMLINE_CAM1_OB2_NAME)] = message_pair( string(CAMLINE_CAM1_OB2_FORMAT), &camLine_CAM1_OB2_message_handler );
	message_handlers[string(CAMLINE_CAM1_OB3_NAME)] = message_pair( string(CAMLINE_CAM1_OB3_FORMAT), &camLine_CAM1_OB3_message_handler );
	message_handlers[string(CAMLINE_CAM1_OB4_NAME)] = message_pair( string(CAMLINE_CAM1_OB4_FORMAT), &camLine_CAM1_OB4_message_handler );
	message_handlers[string(CAMLINE_CAM1_OB5_NAME)] = message_pair( string(CAMLINE_CAM1_OB5_FORMAT), &camLine_CAM1_OB5_message_handler );
	message_handlers[string(CAMLINE_CAM2_OB1_NAME)] = message_pair( string(CAMLINE_CAM2_OB1_FORMAT), &camLine_CAM2_OB1_message_handler );
	message_handlers[string(CAMLINE_CAM2_OB2_NAME)] = message_pair( string(CAMLINE_CAM2_OB2_FORMAT), &camLine_CAM2_OB2_message_handler );
	message_handlers[string(CAMLINE_CAM2_OB3_NAME)] = message_pair( string(CAMLINE_CAM2_OB3_FORMAT), &camLine_CAM2_OB3_message_handler );
	message_handlers[string(CAMLINE_CAM2_OB4_NAME)] = message_pair( string(CAMLINE_CAM2_OB4_FORMAT), &camLine_CAM2_OB4_message_handler );
	message_handlers[string(CAMLINE_CAM2_OB5_NAME)] = message_pair( string(CAMLINE_CAM2_OB5_FORMAT), &camLine_CAM2_OB5_message_handler );
	message_handlers[string(CAMLINE_CAM3_OB1_NAME)] = message_pair( string(CAMLINE_CAM3_OB1_FORMAT), &camLine_CAM3_OB1_message_handler );
	message_handlers[string(CAMLINE_CAM3_OB2_NAME)] = message_pair( string(CAMLINE_CAM3_OB2_FORMAT), &camLine_CAM3_OB2_message_handler );
	message_handlers[string(CAMLINE_CAM3_OB3_NAME)] = message_pair( string(CAMLINE_CAM3_OB3_FORMAT), &camLine_CAM3_OB3_message_handler );
	message_handlers[string(CAMLINE_CAM3_OB4_NAME)] = message_pair( string(CAMLINE_CAM3_OB4_FORMAT), &camLine_CAM3_OB4_message_handler );
	message_handlers[string(CAMLINE_CAM3_OB5_NAME)] = message_pair( string(CAMLINE_CAM3_OB5_FORMAT), &camLine_CAM3_OB5_message_handler );
	

	message_handlers[string(ALIVESTA_CAM1_NAME)] = message_pair( string(ALIVESTA_CAM1_FORMAT), &aliveSta_CAM1_message_handler );
	message_handlers[string(ALIVESTA_CAM2_NAME)] = message_pair( string(ALIVESTA_CAM2_FORMAT), &aliveSta_CAM2_message_handler );
	message_handlers[string(ALIVESTA_CAM3_NAME)] = message_pair( string(ALIVESTA_CAM3_FORMAT), &aliveSta_CAM3_message_handler );
	
	message_handlers[string(LABELINTEGRATE_CAM1_NAME)] = message_pair( string(LABELINTEGRATE_CAM1_FORMAT), &labelIntegrate_CAM1_message_handler );
	message_handlers[string(LABELINTEGRATE_CAM2_NAME)] = message_pair( string(LABELINTEGRATE_CAM2_FORMAT), &labelIntegrate_CAM2_message_handler );
	message_handlers[string(LABELINTEGRATE_CAM3_NAME)] = message_pair( string(LABELINTEGRATE_CAM3_FORMAT), &labelIntegrate_CAM3_message_handler );
...
bool trans2CamLine(CamLineMgr_CAM1_OB1* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb, IplImage* outImgY)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH; j++)
		{
			if (!(int(j - TRANS_STRIPE_WIDTH*0.5 + src->imageLoc[0]) >= 0 && int(j - TRANS_STRIPE_WIDTH*0.5 + src->imageLoc[0]) < IMG_WIDTH)) continue;
			int CrCbVal = (int)(unsigned char)(src->imgdataCrCb[((int)TRANS_STRIPE_WIDTH/4)*(i/4) + (j/4)]);
			int YVal = (int)(unsigned char)(src->imgdataY[((int)TRANS_STRIPE_WIDTH/4)*(i/4) + (j/4)]);
			CV_IMAGE_ELEM(outImgCr, unsigned char, i, int(j - TRANS_STRIPE_WIDTH*0.5 + src->imageLoc[0])) = (CrCbVal/16)*16;
			CV_IMAGE_ELEM(outImgCb, unsigned char, i, int(j - TRANS_STRIPE_WIDTH*0.5 + src->imageLoc[0])) = (CrCbVal%16)*16;
			CV_IMAGE_ELEM(outImgY, unsigned char, i, int(j - TRANS_STRIPE_WIDTH*0.5 + src->imageLoc[0])) = YVal;
...
bool trans2CamLine(CamLineMgr_CAM1_OB2* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb, IplImage* outImgY)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM1_OB3* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb, IplImage* outImgY)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM1_OB4* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb, IplImage* outImgY)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM1_OB5* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb, IplImage* outImgY)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM2_OB1* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb, IplImage* outImgY)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM2_OB2* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb, IplImage* outImgY)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM2_OB3* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb, IplImage* outImgY)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM2_OB4* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb, IplImage* outImgY)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM2_OB5* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb, IplImage* outImgY)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM3_OB1* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb, IplImage* outImgY)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM3_OB2* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb, IplImage* outImgY)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM3_OB3* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb, IplImage* outImgY)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM3_OB4* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb, IplImage* outImgY)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH; j++)
...
bool trans2CamLine(CamLineMgr_CAM3_OB5* src, CameraLine3D* dst, IplImage* outImgCr, IplImage* outImgCb, IplImage* outImgY)
{
	for (int i=0; i<IMG_HEIGHT; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH; j++)
...
bool trans2CamLineMgr(IplImage* inImgY_down4x4, IplImage* inImgCr_down4x4, IplImage* inImgCb_down4x4, CameraLine3D* src, CamLineMgr_CAM1_OB1* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT/4; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH/4; j++)
		{
			if (!(int(j - TRANS_STRIPE_WIDTH/4*0.5 + src->imageLoc.x/4) >= 0 && int(j - TRANS_STRIPE_WIDTH/4*0.5 + src->imageLoc.x/4) < IMG_WIDTH/4)) continue;
			int CrVal = (int)CV_IMAGE_ELEM(inImgCr_down4x4, unsigned char, i, int(j - TRANS_STRIPE_WIDTH/4*0.5 + src->imageLoc.x/4))/16;
			int CbVal = (int)CV_IMAGE_ELEM(inImgCb_down4x4, unsigned char, i, int(j - TRANS_STRIPE_WIDTH/4*0.5 + src->imageLoc.x/4))/16;
			int YVal = (int)CV_IMAGE_ELEM(inImgY_down4x4, unsigned char, i, int(j - TRANS_STRIPE_WIDTH/4*0.5 + src->imageLoc.x/4));
			dst->imgdataCrCb[((int)TRANS_STRIPE_WIDTH/4)*i + j] = CrVal*16 + CbVal;
			dst->imgdataCrCb[((int)TRANS_STRIPE_WIDTH/4)*i + j] = YVal;
		}
	}
...
bool trans2CamLineMgr(IplImage* inImgY_down4x4, IplImage* inImgCr_down4x4, IplImage* inImgCb_down4x4, CameraLine3D* src, CamLineMgr_CAM1_OB2* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT/4; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH/4; j++)
...
bool trans2CamLineMgr(IplImage* inImgY_down4x4, IplImage* inImgCr_down4x4, IplImage* inImgCb_down4x4, CameraLine3D* src, CamLineMgr_CAM1_OB3* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT/4; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH/4; j++)
...
bool trans2CamLineMgr(IplImage* inImgY_down4x4, IplImage* inImgCr_down4x4, IplImage* inImgCb_down4x4, CameraLine3D* src, CamLineMgr_CAM1_OB4* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT/4; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH/4; j++)
...
bool trans2CamLineMgr(IplImage* inImgY_down4x4, IplImage* inImgCr_down4x4, IplImage* inImgCb_down4x4, CameraLine3D* src, CamLineMgr_CAM1_OB5* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT/4; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH/4; j++)
...
bool trans2CamLineMgr(IplImage* inImgY_down4x4, IplImage* inImgCr_down4x4, IplImage* inImgCb_down4x4, CameraLine3D* src, CamLineMgr_CAM2_OB1* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT/4; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH/4; j++)
...
bool trans2CamLineMgr(IplImage* inImgY_down4x4, IplImage* inImgCr_down4x4, IplImage* inImgCb_down4x4, CameraLine3D* src, CamLineMgr_CAM2_OB2* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT/4; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH/4; j++)
...
bool trans2CamLineMgr(IplImage* inImgY_down4x4, IplImage* inImgCr_down4x4, IplImage* inImgCb_down4x4, CameraLine3D* src, CamLineMgr_CAM2_OB3* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT/4; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH/4; j++)
...
bool trans2CamLineMgr(IplImage* inImgY_down4x4, IplImage* inImgCr_down4x4, IplImage* inImgCb_down4x4, CameraLine3D* src, CamLineMgr_CAM2_OB4* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT/4; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH/4; j++)
...
bool trans2CamLineMgr(IplImage* inImgY_down4x4, IplImage* inImgCr_down4x4, IplImage* inImgCb_down4x4, CameraLine3D* src, CamLineMgr_CAM2_OB5* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT/4; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH/4; j++)
...
bool trans2CamLineMgr(IplImage* inImgY_down4x4, IplImage* inImgCr_down4x4, IplImage* inImgCb_down4x4, CameraLine3D* src, CamLineMgr_CAM3_OB1* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT/4; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH/4; j++)
...
bool trans2CamLineMgr(IplImage* inImgY_down4x4, IplImage* inImgCr_down4x4, IplImage* inImgCb_down4x4, CameraLine3D* src, CamLineMgr_CAM3_OB2* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT/4; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH/4; j++)
...
bool trans2CamLineMgr(IplImage* inImgY_down4x4, IplImage* inImgCr_down4x4, IplImage* inImgCb_down4x4, CameraLine3D* src, CamLineMgr_CAM3_OB3* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT/4; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH/4; j++)
...
bool trans2CamLineMgr(IplImage* inImgY_down4x4, IplImage* inImgCr_down4x4, IplImage* inImgCb_down4x4, CameraLine3D* src, CamLineMgr_CAM3_OB4* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT/4; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH/4; j++)
...
bool trans2CamLineMgr(IplImage* inImgY_down4x4, IplImage* inImgCr_down4x4, IplImage* inImgCb_down4x4, CameraLine3D* src, CamLineMgr_CAM3_OB5* dst, int timeIndex)
{
	for (int i=0; i<IMG_HEIGHT/4; i++)
	{
		for (int j=0; j<TRANS_STRIPE_WIDTH/4; j++)
