...
public:
	...
	CvHistogram* bodyH[NUM_OF_BLOCKS];
	...
	bool LocateAndMeasureInfoH(const CameraLine3D * headline, CameraLine3D & groundline, bool h_is_got, double h, IplImage* src_Cr, IplImage* src_Cb, IplImage* msk);
